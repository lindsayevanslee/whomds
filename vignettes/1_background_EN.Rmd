---
title: "Background on disability measurement"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Background on disability measurement}
...
iteration <- tibble(from=c("Run model", "Test model\nassumptions","Adjust data"),
                    to=c("Adjust data","Run model", "Test model\nassumptions"))

ggplot(data=iteration, aes(from_id=from, to_id=to, fontsize = 3)) +
  geomnet::geom_net(color="#0099ff", size=25,
           layout.alg = "fruchtermanreingold",
           directed=TRUE, arrowsize = 1.5, arrowgap = 0.75,
           labelon = TRUE, labelcolour = "white") +
