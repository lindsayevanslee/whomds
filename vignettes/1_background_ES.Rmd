---
title: "Antecedentes sobre la medición de discapacidad"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Antecedentes sobre la medición de discapacidad}
...
<!-- eventually put data analysis infographic here -->
...
``` {r iteration, echo=FALSE, eval=TRUE, out.width = NULL}
iteration <- tibble(from=c("Ejecutar modelo", "Probar suposiciones","Ajustar datos"),
                    to=c("Ajustar datos","Ejecutar modelo", "Probar suposiciones"))

ggplot(data=iteration, aes(from_id=from, to_id=to)) +
  geomnet::geom_net(color="#0099ff", size=40,
           layout.alg = "fruchtermanreingold",
           directed=TRUE, arrowsize = 1.5, arrowgap = 0.75,
           labelon = TRUE, labelcolour = "white", fontsize = 3) +
