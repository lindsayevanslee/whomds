---
title: "Rasch Analysis for MDS data from adults"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Rasch Analysis for MDS data from adults}
