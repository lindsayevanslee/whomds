---
title: "After Rasch Analysis: Descriptive Analysis"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{After Rasch Analysis: Descriptive Analysis}
...
If we would like to spread the table again so that `disability_cat` represents the columns again, we can feed this table into another function that will perform the spread. The function to spread tables is called, naturally, `spread()`, and it is in the `tidyr` package. To perform a second spread, write the code like this:
...
table_unweightedpctn(df_adults, 
