---
title: "Análisis Rasch con los datos de adultos de MDS"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Análisis Rasch con los datos de adultos de MDS}
...
include_graphics("ExampleRasch_EF/Start/LID_plot.pdf")
```
...
include_graphics("ExampleRasch_EF/Start/parallel_analysis_scree.pdf")
```
...
include_graphics("ExampleRasch_EF/Start/PImap.pdf")
```
...
include_graphics("ExampleRasch_EF/Testlet1_Recode1/PImap.pdf")
```
...
include_graphics("ExampleRasch_EF/Testlet1_Recode2/PImap.pdf")
```
...
include_graphics("ExampleRasch_EF/Testlet1_Recode3/PImap.pdf")
```
...
include_graphics("ExampleRasch_EF/Testlet1_Recode4/PImap.pdf")
```
