...
An extensive guide on using the package is available. Please email me at leel@who.int for access. Some of the information is already included in vignettes for this package. In the future, all information in the guide will be included as vignettes.
