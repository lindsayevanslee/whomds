...
<!-- badges: start -->
[![Build Status](https://app.travis-ci.com/lindsayevanslee/whomds.svg?branch=master)](https://app.travis-ci.com/lindsayevanslee/whomds)
...
It is expected the package will soon be uploaded to CRAN. Once available there, you can install with:
